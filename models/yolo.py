    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            if m in {BottleneckCSP, SPPCSPC}:
                ...
                n = 1
        elif m is nn.BatchNorm2d:   # k dung den trong yolov9c
            args = [ch[f]]
        elif m is Concat:
            c2 = sum(ch[x] for x in f)
        elif m is Shortcut:  # k dung den trong yolov9c
            c2 = ch[f[0]]
        elif m is ReOrg:     # k dung den trong yolov9c
            c2 = ch[f] * 4
        elif m is CBLinear:
            c2 = args[0]
            c1 = ch[f]
        ...
        elif m is Contract:  # k dung den trong yolov9c
            c2 = ch[f] * args[0] ** 2
        elif m is Expand:    # k dung den trong yolov9c
            c2 = ch[f] // args[0] ** 2
        else:
            c2 = ch[f]
        ...
        if i == 0:
            ch = []
        ch.append(c2)   #output channel of this layer, from 0
